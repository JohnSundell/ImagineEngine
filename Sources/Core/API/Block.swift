...
public extension Block {
    ...
    convenience init(size: Size, textureCollectionName: String, textureScale: Int? = nil, textureFormat: TextureFormat = .png) {
    ...
    convenience init(size: Size, spriteSheetName: String, textureScale: Int? = nil, textureFormat: TextureFormat = .png) {
